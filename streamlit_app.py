...
st.title("🔮 **Hybrid Diabetes Prediction System (ML + Fuzzy)**")
...
if st.button("🔮 Prediksi Sekarang"):
    ...
    st.subheader("🎯 Skor Risiko Diabetes")
    st.progress(int(hasil))

    st.write(f"### Risiko Anda: **{hasil:.2f}%**")

    if hasil > 50:
        st.error("⚠ Tinggi! Risiko Diabetes signifikan.")
    else:
        st.success("✔ Rendah! Risiko Diabetes terkendali.")
